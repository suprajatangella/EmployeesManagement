...
namespace EmployeesManagement.Controllers
{
    public class AuditsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,UserId,AuditType,TableName,Date,OldValues,NewValues,AffectedColumns,PrimaryKey")] Audit audit)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,UserId,AuditType,TableName,Date,OldValues,NewValues,AffectedColumns,PrimaryKey")] Audit audit)
        {
            if (id != audit.Id)
            {
                return NotFound();
