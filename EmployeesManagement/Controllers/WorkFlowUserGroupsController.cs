...
namespace EmployeesManagement.Controllers
{
    public class WorkFlowUserGroupsController : Controller
    {
        ...
        {
            ViewData["DocumentTypeId"] = new SelectList(_context.SystemCodeDetails.Include(s => s.SystemCode).Where(y => y.SystemCode.Code == "DocumentTypes"), "Id", "Description");
        ...
        public async Task<IActionResult> Create([Bind("Id,Code,Description")] WorkFlowUserGroup workFlowUserGroup)
        {
            ...
            //if (ModelState.IsValid)
            {
                ...
                ViewData["DocumentTypeId"] = new SelectList(_context.SystemCodeDetails.Include(s => s.SystemCode).Where(y => y.SystemCode.Code == "DocumentTypes"), "Id", "Description", workFlowUserGroup.DocumentTypeId);
